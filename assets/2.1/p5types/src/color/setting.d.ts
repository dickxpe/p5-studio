...
declare module '../../index' {
    interface p5InstanceExtensions {
         ...
         *   current color range (default is 0-255).
         */
        background(image: Image, a?: number): void
        ...
        //
        // colorMode(mode: RGB|HSB|HSL|RGBHDR|HWB|LAB|LCH|OKLAB|OKLCH, max?: number): undefined
        ...
        //    return has invalid type: RGB|HSB|HSL|RGBHDR|HWB|LAB|LCH|OKLAB|OKLCH
        //
        // colorMode(mode: RGB|HSB|HSL|RGBHDR|HWB|LAB|LCH|OKLAB|OKLCH, max1: number, max2: number, max3: number, maxA?: number): undefined
