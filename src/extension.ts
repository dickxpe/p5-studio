...
#reload-button{position:fixed;top:10px;right:10px;width:24px;height:24px;cursor:pointer;z-index:9999;}
...
if(typeof setup==='function'){const userSetup=setup;setup=function(){try{if(typeof createCanvas==='function'){createCanvas(window.innerWidth,window.innerHeight);}userSetup();if(typeof get==='function'){const c=get(0,0);window._p5Background=color(c[0],c[1],c[2],c[3]);}clearError();}catch(e){showError('[Setup Error] '+(e.message||e));throw e;}}}
